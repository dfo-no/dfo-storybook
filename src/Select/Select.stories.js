...
export const WrappingAdvancedSelect = () => (
  <div style={{ maxWidth: '705px' }}>
    <Select
      name="wrapping-advanced-select">
...
export const SelectedWithPlainStringOptions = () => (
  <div style={{ maxWidth: '705px' }}>
    <Select
      name="placeholder-select"
      placeholder="Select option"
...
export const OptionsWithCustomDisplayAttribute = () => (
  <div style={{ maxWidth: '705px' }}>
    <Select
      name="placeholder-select"
      placeholder="Select option"
