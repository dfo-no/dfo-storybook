interface NavSymbolProps {
  light?: boolean,
  download?: boolean,
  external?: boolean,
}

const ExternalSVG = ({ fill }: { fill: string }) => (
...
const DownloadSVG = ({ fill }: { fill: string }) => (
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" viewBox="0 0 22 22">
...
const DefaultSVG = ({ fill }: { fill: string }) => (
